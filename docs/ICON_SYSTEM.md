...
用户可在“设置 → 图标颜色”中选择“多彩”或红、橙、黄、绿、青、蓝、
靛、紫、洋红九种统一单色。选择结果保存到本地偏好设置，重启后保持不变。
应用内图标只使用 Iconoir 线条着色，不在图标背后添加彩色填充底板。
桌面九尾狐图标同样使用九色线稿：狐身、九条尾巴和画布均无实色填充，PNG 必须保留真实 Alpha 透明通道。
